...
const RemoveFromUserSuggestionsBehavior = require('@api/behaviors/removeFromUserSuggestions.bv');
...
describe('Suggestions remover', () => {
    ...
    describe('Remove from session', () => {
        it('should return if no session is provided', (done) => {
            RemoveFromUserSuggestionsBehavior.removeFromSession(null, 'fakeuserid');
            done();
        });
        it('should return if session has no suggestions', (done) => {
            ...
            RemoveFromUserSuggestionsBehavior.removeFromSession(sessionStub, 'fakeuserid');
